...
<section class=" p-0 sm:p-5 antialiased">
    <h2 class="text-extrabold text-xl pl-5 mb-5 font-medium">
                    ...
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search" name="keyword"
                                ...
                                value="{{ request('keyword') }}" placeholder="Search Post Title or Category"
                                autocomplete="off">
                        </div>
                    </form>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($posts as $post)
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    {{ $loop->index + 1 + ($posts->firstItem() - 1) }}</th>
                                <td class="px-4 py-3 hover:text-gray-900 hover:font-bold"><a
                                        href="/dashboard/{{ $post->slug }}">{{ $post->title }}</a>
                                </td>
                                <td class="px-4 py-3">{{ $post->category->name }}</td>
                                <td class="px-4 py-3">{{ $post->created_at->diffForHumans() }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="{{ $post->slug }}-dropdown-button"
                                        data-dropdown-toggle="{{ $post->slug }}-dropdown"
                                    ...
                                    <div id="{{ $post->slug }}-dropdown"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm" aria-labelledby="{{ $post->slug }}-dropdown-button">
                                            <li>
                        ...
                        @empty
                            <div class="justify-between text-center py-10">
                                <span class="text-2xl font-bold">Data not found</span>
                            </div>
                        @endforelse
                    </tbody>
                </table>
