<div>
    <header
        ...
        <div class="py-4 mx-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <h1 class="text-3xl font-bold tracking-tight text-white">{{ $header }}</h1>
            @if (request()->is('posts'))
                <form class="w-full md:w-auto md:max-w-md">
                    @if (request('category'))
                    ...
                    <div class="relative">
                        ...
                        <button type="submit"
                            class="text-white absolute end-2.5 bottom-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg
                                class="w-4 h-4 text-gray-500 dark:text-gray-100" aria-hidden="true"
